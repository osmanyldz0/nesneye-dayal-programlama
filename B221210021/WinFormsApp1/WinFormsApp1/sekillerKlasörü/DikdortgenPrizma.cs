...
{
    public class DikdortgenPrizma : sekiller
    {
        ...
        public DikdortgenPrizma(UcBoyutluNokta nokta, int boy, int en)
        {
            Nokta = nokta;
        ...
        public string yazdir()
        {
            ...
            return $"Başlangıç noktsı Nokta (x,y,z) = ({Nokta.X}, {Nokta.Y}, {Nokta.Z}) olan, eni {en}, boyu {boy} ve derinliği {derinlik} olan dikdörtgen prizması";
